...
export declare class BotSpecificClient<TBot extends BaseBot> {
    ...
    getOrSetState: routes.GetOrSetState<TBot>;
    patchState: routes.PatchState<TBot>;
    callAction: routes.CallAction<TBot>;
    uploadFile: routes.UploadFile<TBot>;
    upsertFile: routes.UpsertFile<TBot>;
    deleteFile: routes.DeleteFile<TBot>;
    listFiles: routes.ListFiles<TBot>;
    getFile: routes.GetFile<TBot>;
    updateFileMetadata: routes.UpdateFileMetadata<TBot>;
    searchFiles: routes.SearchFiles<TBot>;
    /**
