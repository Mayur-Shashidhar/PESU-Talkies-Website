...
export declare class IntegrationSpecificClient<TIntegration extends BaseIntegration> {
    ...
    uploadFile: routes.UploadFile<TIntegration>;
    upsertFile: routes.UpsertFile<TIntegration>;
    deleteFile: routes.DeleteFile<TIntegration>;
    listFiles: routes.ListFiles<TIntegration>;
    getFile: routes.GetFile<TIntegration>;
    updateFileMetadata: routes.UpdateFileMetadata<TIntegration>;
}
